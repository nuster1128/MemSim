        ...
        for noise_event_id in range(len(event_list)):
            if noise_event_id != event_C1_id:
                ...
                if k == '我要参加的活动':
                    ...
                    text = rewrite_message_event("我将要参加%s活动。" % name, charact)
                else:
...
# def rewrite_combined_question(question_text):
#     prompt = "[问题] 你好小艺，%s \n" % question_text
#     prompt += "请帮我把上面问题中提到的问题，用一段简单的背景联系起来，形成一句话。"
#     prompt += "只输出重写后的问题，不要输出原有的问题，不要输出其他描述信息。\n"
#     prompt += "输出示例：你好小艺，我今天和我的上司路过了一家医院，你还记得是那家医院叫什么吗？我的上司叫什么？"
...
def generate_simple_facts_addition(graph_list):
    ...
    data_list = []
    output_path = '01_simple_hybrid.json'
